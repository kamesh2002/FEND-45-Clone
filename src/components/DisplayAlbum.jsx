...
const DisplayAlbum = () => {
  ...
  return (
    <>
    <Navbar/>
    <div className=' mt-15 flex gap-8 flex-col md:flex-row md:items-end pt-5'>
        ...
        <div className='flex flex-col'>
            ...
            <p className='mt-1'>
                ...
                <ul role="list" class="marker:text-sky-400 list-disc flex flex-row space-x-1 pl-3">
